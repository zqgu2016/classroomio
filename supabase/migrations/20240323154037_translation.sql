create type "public"."LOCALE" as enum ('en', 'hi', 'fr', 'pt', 'de', 'vi', 'ru', 'es', 'zh');
...
create table
  public.lesson_language (
    ...
    locale "LOCALE" default 'zh'::"LOCALE",
...
alter table "public"."profile" add column "locale" "LOCALE" default 'zh'::"LOCALE";