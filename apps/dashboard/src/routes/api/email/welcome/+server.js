  ...
  const emailData = [
    {
      ...
      to,
      subject: 'Welcome to OpenAgents Academy!',
      content: `
    <p>Dear ${name},</p>
      <p>My name is Best, the founder of OpenAgents Academy. I saw you signed up, any questions so far?</p>
      <p>
      ...
      <div>
        <a href="https://academy.openagentsfoundation.org/demo">Book demo</a>
      </div>
      <p>
